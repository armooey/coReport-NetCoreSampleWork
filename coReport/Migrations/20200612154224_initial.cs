        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentActivityId = table.Column<short>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfileImageHistory", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReportAttachmentHistory", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<short>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Title = table.Column<string>(nullable: true),
                    SenderId = table.Column<short>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubActivityId = table.Column<short>(nullable: true),
                    ActivityApendix = table.Column<string>(nullable: true),
                    Text = table.Column<string>(nullable: true),
                    ...
                    AttachmentName = table.Column<string>(nullable: true),
                    InvalidReportMessageId = table.Column<short>(nullable: false),
                    IsDeleted = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reports_Activities_SubActivityId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorId = table.Column<short>(nullable: false),
                    Date = table.Column<DateTime>(nullable: false),
                    IsUserReportAcceptable = table.Column<bool>(nullable: false),
                    IsCommentViewableByUser = table.Column<bool>(nullable: false),
                    ReviewMessageId = table.Column<short>(nullable: false),
                    IsDeleted = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ManagerReports_Reports_ReportId",
                        column: x => x.ReportId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ManagerReports_ReportId",
                table: "ManagerReports",
                column: "ReportId");
