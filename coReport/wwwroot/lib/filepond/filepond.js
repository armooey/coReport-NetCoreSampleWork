...
(function(global, factory) {
  ...
  var defaultOptions = {
    ...
    labelIdle: [
      'فایل را بکشید و رها کنید یا <span class="filepond--label-action">انتخاب کنید</span>',
      Type.STRING
    ],
    labelInvalidField: ['فایل نامعتبر', Type.STRING],
    labelFileWaitingForSize: ['محاسبه سایز', Type.STRING],
    labelFileSizeNotAvailable: ['سایز قابل محاسبه نیست', Type.STRING],
    labelFileCountSingular: ['فایل در لیست', Type.STRING],
    labelFileCountPlural: ['فایل ها در لیست', Type.STRING],
    labelFileLoading: ['بارگذاری', Type.STRING],
    labelFileAdded: ['اضافه شد', Type.STRING], // assistive only
    labelFileLoadError: ['خطا در بارگذاری', Type.STRING],
    labelFileRemoved: ['حذف شد', Type.STRING], // assistive only
    labelFileRemoveError: ['خطا در حذف فایل', Type.STRING],
    labelFileProcessing: ['در حال آپلود', Type.STRING],
    labelFileProcessingComplete: ['آپلود کامل شد', Type.STRING],
    labelFileProcessingAborted: ['آپلود کنسل شد', Type.STRING],
    labelFileProcessingError: ['خطا در هنگام آپلود', Type.STRING],
    labelFileProcessingRevertError: ['خطا در بازگیری', Type.STRING],

    labelTapToCancel: ['انصراف', Type.STRING],
    labelTapToRetry: ['تلاش مجدد', Type.STRING],
    labelTapToUndo: ['بازگشت', Type.STRING],

    labelButtonRemoveItem: ['حذف', Type.STRING],
    labelButtonAbortItemLoad: ['صرف نظر', Type.STRING],
    labelButtonRetryItemLoad: ['تلاش مجدد', Type.STRING],
    labelButtonAbortItemProcessing: ['انصراف', Type.STRING],
    labelButtonUndoItemProcessing: ['بازگشت', Type.STRING],
    labelButtonRetryItemProcessing: ['تلاش مجدد', Type.STRING],
    labelButtonProcessItem: ['آپلود', Type.STRING],
