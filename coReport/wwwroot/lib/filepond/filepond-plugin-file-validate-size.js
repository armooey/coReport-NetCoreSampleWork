  ...
  var plugin = function plugin(_ref) {
    ...
    return {
      options: {
        ...
        // error labels
        labelMinFileSizeExceeded: ['فایل بسیار کوچک است', Type.STRING],
        labelMinFileSize: ['حداقل سایز فایل {filesize} است', Type.STRING],

        labelMaxFileSizeExceeded: ['فایل بسیار بزرگ است', Type.STRING],
        labelMaxFileSize: ['حداکثر سایز فایل {filesize} است', Type.STRING],
